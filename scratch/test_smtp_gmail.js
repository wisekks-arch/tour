...
console.log('--- Testing Gmail SMTP (smtp.gmail.com:465) ---');
sendSmtpMail({
  host: 'smtp.gmail.com',
  port: 465,
  ...
  subject: '[투어이지] Gmail SMTP 발송 테스트',
  html: '<p>Gmail SMTP 테스트 메일입니다.</p>'
})
.then(res => console.log('✅ Gmail SMTP Success:', res.message))
